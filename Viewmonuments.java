...
public class Viewmonuments extends JFrame implements Runnable{
    ...
    public void run(){
        String [] text=new String[]{"Grand Jamia Masjid","Baab-e-Khyber","Minar-e-Pakistan","Tomb Shah R.Alam","Teen Talwar","Tomb of Jahanghir","Faisal Masjid","Badshahi Masjid","Pakistan Monument","Ziarat Residency"};
        try {
            for (int i=0;i<=9;i++){
    ...
    Viewmonuments(){
        ...
        caption=new JLabel();
        caption.setBounds(50,30,300,40);
        ...
        for (int i=0;i<=9;i++){
            img[i]=new ImageIcon(ClassLoader.getSystemResource("icons/mon"+(i+1)+".jpg"));
