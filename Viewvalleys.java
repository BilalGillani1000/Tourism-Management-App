...
public class Viewvalleys extends JFrame implements Runnable{
    ...
    public void run(){
        String [] text=new String[]{"Gilgit Valley","Chitral Valley","Hunza Valley","Murree Valley","Nelum Valley","Nagar Valley","Skardu Valley","Naran Valley","Sawat Valley","Kagan valley"};
        try {
            for (int i=0;i<=9;i++){
    ...
    Viewvalleys(){
        ...
        caption=new JLabel();
        caption.setBounds(50,30,250,30);
        ...
        for (int i=0;i<=9;i++){
            img[i]=new ImageIcon(ClassLoader.getSystemResource("icons/valley"+(i+1)+".jpg"));
